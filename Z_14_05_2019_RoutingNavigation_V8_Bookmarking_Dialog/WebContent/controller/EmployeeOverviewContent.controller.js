sap.ui.define([
	...
	return BaseController.extend("sap.ui.opensap.controller.EmployeeOverviewContent", {
...
//			oCtx = oItem.getBindingContext();
			oCtx = oItem.getBindingContext("employees").getObject();
			this.getRouter().navTo("employeeResume",{
//				employeeId : oCtx.getProperty("EmployeeID"),
				employeeId : oCtx.EmployeeID ,
				resume     : "resume",
				query : {
					tab : "Info"
				}
